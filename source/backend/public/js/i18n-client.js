...
class I18nClient {
    ...
    async loadTranslations(locale) {
        try {
            ...
            // Handle the new API format wrapped in data property, or fallback to direct/legacy formats
            this.translations[locale] = data.data?.translations || data.translations || data;
